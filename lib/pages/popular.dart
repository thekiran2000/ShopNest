          ...
          if(snapshot.hasData){
            ...
            return ListView.builder(
                ...
                itemBuilder: (context,index){
                  ...
                  if(documentSnapshot["Rating_Final"]>=4) return Container(
                    height: 250,
                    child: InkWell(
                      onTap: (){
                        func(documentSnapshot["shop_hash"],documentSnapshot["Category"]);
                      },
                      child: Card(
                        child: Padding(
                          ...
                          child: Row(
                            children: [
                              Image.network(documentSnapshot["Image"],width: 160,),
                              Flexible(
                                fit: FlexFit.loose,
                                child: Padding(
                                  padding: const EdgeInsets.all(8.0),
...
//                                                if(dash==false)adddetails(documentSnapshot["Product"],documentSnapshot["Category"],documentSnapshot["Quantity"],documentSnapshot["Price"],documentSnapshot["Image"],DateTime.now().microsecondsSinceEpoch,documentSnapshot["Discount"],documentSnapshot["Brand"],documentSnapshot["shop_hash"],documentSnapshot["Rating"],documentSnapshot["Rating_Count"],documentSnapshot["shop_id"],documentSnapshot["Shop_name"]);
                                          ...
                                          child: Column(
                                            children: [
                                              if(documentSnapshot["Product"].toString().length>60) Text("${documentSnapshot["Product"].toString().substring(0,59)}...",style:GoogleFonts.raleway(fontSize: 17,fontWeight: FontWeight.bold)),
                                              if(documentSnapshot["Product"].toString().length<=60) Text(documentSnapshot["Product"],style:GoogleFonts.raleway(fontSize: 17,fontWeight: FontWeight.bold)),
                                            ],
                                          )
                                      ),
                                      Padding(
